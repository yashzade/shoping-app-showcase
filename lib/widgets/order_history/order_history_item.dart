...
class OrderHistoryItem3 extends StatelessWidget {
  final Map item;
  OrderHistoryItem3({@required this.item});
  ...
  Widget buildItemDetails(Map item, BuildContext context) {
    return Flexible(
      child: Container(
        height: 70,
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text(
                    '${item['weight']} . ₹${item['price']} . ${item['quantity']}qty',
